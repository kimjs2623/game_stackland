...
export const RECIPES = [
    ...
    { id: 's7', category: 'mining', tier: 1, inputs: ['iron', 'stone', 'fire'], results: ['golem_core'], turns: 3, desc: '골렘 코어 조립', isSpecialty: true, unlockId: 'golem_core' },
    { id: 's8', category: 'cooking', tier: 1, inputs: ['bread', 'water', 'seed'], results: ['fairy_bread'], turns: 3, desc: '요정의 빵 굽기', isSpecialty: true, unlockId: 'fairy_bread' },
    { id: 's9', category: 'woodcraft', tier: 1, inputs: ['paper', 'water', 'fire'], results: ['magic_book'], turns: 3, desc: '마법 마도서 제작', isSpecialty: true, unlockId: 'magic_book' },
    ...
    { id: 's10', category: 'mining', tier: 2, inputs: ['golem_core', 'research', 'iron'], results: ['mecha_golem'], turns: 4, desc: '메카 골렘 가동', isSpecialty: true, unlockId: 'golem_core' },
    { id: 's11', category: 'cooking', tier: 2, inputs: ['fairy_bread', 'research', 'water'], results: ['ambrosia'], turns: 4, desc: '암브로시아 양조', isSpecialty: true, unlockId: 'fairy_bread' },
    { id: 's12', category: 'woodcraft', tier: 2, inputs: ['magic_book', 'research', 'paper'], results: ['ancient_scroll'], turns: 4, desc: '고대 마도서 복원', isSpecialty: true, unlockId: 'magic_book' }
];

export const SPECIALTY_OPTIONS_ALL = [
    { id: 'mana_crystal', name: '마나석 (채광)', desc: '물, 바위, 불을 결합해 만드는 1티어 보석.', icon: '<i class="ph-fill ph-sketch-logo text-5xl text-indigo-500 mb-2"></i>' },
    { id: 'golden_apple', name: '황금사과 (농업)', desc: '씨앗, 나무, 물로 재배하는 1티어 열매.', icon: '<i class="ph-fill ph-apple-logo text-5xl text-red-500 mb-2"></i>' },
    { id: 'sky_cloth', name: '천공의 천 (목공)', desc: '밀, 불, 물을 가공해 만드는 1티어 마법 천.', icon: '<i class="ph-fill ph-scroll text-5xl text-sky-500 mb-2"></i>' },
    { id: 'golem_core', name: '골렘 코어 (채광)', desc: '철, 바위, 불을 결합해 만드는 기계 심장.', icon: '<i class="ph-fill ph-cpu text-5xl text-zinc-500 mb-2"></i>' },
    { id: 'fairy_bread', name: '요정의 빵 (요리)', desc: '빵, 물, 씨앗으로 굽는 달콤한 마법 빵.', icon: '<i class="ph-fill ph-bread text-5xl text-pink-400 mb-2"></i>' },
    { id: 'magic_book', name: '마법 마도서 (목공)', desc: '종이, 물, 불로 제작하는 마법 부여 책.', icon: '<i class="ph-fill ph-book-bookmark text-5xl text-purple-500 mb-2"></i>' }
];

export const MARKET_EVENTS = [
    { msg: "[속보] 거대한 철광맥 발견! 철강 공급 과잉으로 철 가격 폭락 예상.", target: "iron", effect: 0.5, type: "down", title: "철강 파동" },
    { msg: "[속보] 흉작으로 인한 식량난! 밀과 빵의 수요가 폭발합니다.", targets: ["wheat", "bread"], effect: 1.8, type: "up", title: "심각한 식량난" },
    { msg: "[이슈] 왕실 직속 기사단 창설. 강철 무기와 마나석 수요 급증!", targets: ["steel", "mana_crystal"], effect: 2.0, type: "up", title: "기사단 창설" },
    { msg: "[재난] 대규모 산불로 숲 소실. 나무와 목탄 가격이 천정부지로 솟습니다.", targets: ["wood", "charcoal"], effect: 1.5, type: "up", title: "대형 산불" },
    { msg: "[동향] 건축 붐 발생! 벽돌과 강철 가격 급등 중.", targets: ["brick", "steel"], effect: 1.4, type: "up", title: "건축 붐" },
    { msg: "[연구] 아카데미에서 대규모 논문 지원금 지급. 연구 데이터 가격 상승!", target: "research", effect: 1.8, type: "up", title: "연구 지원금" }
];